...
var DEMO_USERNAME = process.env.DEMO_USERNAME || "admin";
var DEMO_PASSWORD = process.env.DEMO_PASSWORD || "admin";
var JWT_SECRET = process.env.JWT_SECRET || "observability-demo-secret";
var DEMO_USER = {
  id: 1,
  ...
  if (username === DEMO_USERNAME && password === DEMO_PASSWORD) {
    try {
      ...
      const cookieParts = [
        ...
        `Max-Age=${Math.floor(ONE_YEAR_MS / 1e3)}`,
        "Path=/",
        "HttpOnly",
        "SameSite=None"
      ];
